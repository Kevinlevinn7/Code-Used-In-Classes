...
**************************
capture log close
log using econ5813ProblemSet5.log, replace
set more off
set linesize 255
set varabbrev off
...
reg lnwage female exp exp2 hs elem ma college hisp black asian other_race

***************************
**** Roboust*********
********************************
reg lnwage female exp exp2 elem hs college ma hisp black asian other_race, robust

************************************************************
****** State fixed effects, and ommiteed state.*********
*************************************************************
reg lnwage female exp exp2 elem hs college ma hisp black asian other_race i.statefip, robust baselevels

*********************************************
******** Interaction terms *********
********************************************
reg lnwage exp exp2 elem hs college ma hisp black asian other_race i.sex##i.statefip, baselevels



reg lnwage exp exp2 elem hs college ma hisp black asian other_race i.sex##ib(6).statefip, baselevels
